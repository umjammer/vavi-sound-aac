...
import static net.sourceforge.jaad.aac.ps.PSTables.COEF_SQRT2;
import static net.sourceforge.jaad.aac.ps.PSTables.DECAY_SLOPE;
import static net.sourceforge.jaad.aac.ps.PSTables.MAX_PS_ENVELOPES;
import static net.sourceforge.jaad.aac.ps.PSTables.NO_ALLPASS_LINKS;
import static net.sourceforge.jaad.aac.ps.PSTables.Phi_Fract_Qmf;
import static net.sourceforge.jaad.aac.ps.PSTables.Q_Fract_allpass_Qmf;
import static net.sourceforge.jaad.aac.ps.PSTables.cos_alphas;
...
import static net.sourceforge.jaad.aac.ps.PSTables.delay_length_d;
import static net.sourceforge.jaad.aac.ps.PSTables.filter_a;
import static net.sourceforge.jaad.aac.ps.PSTables.ipdopd_cos_tab;
import static net.sourceforge.jaad.aac.ps.PSTables.ipdopd_sin_tab;
import static net.sourceforge.jaad.aac.ps.PSTables.nr_icc_par_tab;
import static net.sourceforge.jaad.aac.ps.PSTables.nr_iid_par_tab;
import static net.sourceforge.jaad.aac.ps.PSTables.nr_ipdopd_par_tab;
import static net.sourceforge.jaad.aac.ps.PSTables.num_env_tab;
...
import static net.sourceforge.jaad.aac.ps.PSTables.sin_alphas;
...
public class PSOrig implements PS {
    ...
    final boolean[] iid_dt = new boolean[MAX_PS_ENVELOPES];
    final boolean[] icc_dt = new boolean[MAX_PS_ENVELOPES];
    boolean enable_ipdopd;
    int ipd_mode;
    final boolean[] ipd_dt = new boolean[MAX_PS_ENVELOPES];
    final boolean[] opd_dt = new boolean[MAX_PS_ENVELOPES];

    // indices
    final int[] iid_index_prev = new int[34];
    final int[] icc_index_prev = new int[34];
    final int[] ipd_index_prev = new int[17];
    final int[] opd_index_prev = new int[17];
    final int[][] iid_index = new int[MAX_PS_ENVELOPES][34];
    final int[][] icc_index = new int[MAX_PS_ENVELOPES][34];
    final int[][] ipd_index = new int[MAX_PS_ENVELOPES][17];
    final int[][] opd_index = new int[MAX_PS_ENVELOPES][17];
    ...
    int phase_hist;
    final float[][][] ipd_prev = new float[20][2][2];
    final float[][][] opd_prev = new float[20][2][2];
